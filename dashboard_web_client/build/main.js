...
/***/ function(module, exports, __webpack_require__) {
	...
	var endpoint = 'http://0.0.0.0:8000/api/v1/';
	window.endpoint = endpoint;
	
	var myApp = angular.module('myApp', ['ng-admin', 'ng-admin.jwt-auth', 'ngDialog', 'util']);
	...
	myApp.directive('attributeField', __webpack_require__(8));
	
	// custom 'amount' type
	myApp.config(['NgAdminConfigurationProvider', 'FieldViewConfigurationProvider', function (nga, fvp) {
	    nga.registerFieldType('amount', __webpack_require__(9));
	    fvp.registerFieldView('amount', __webpack_require__(13));
	
	    nga.registerFieldType('attributes', __webpack_require__(14));
	    fvp.registerFieldView('attributes', __webpack_require__(16));
	}]);
	
	// custom directives
	myApp.directive('dashboardSummary', __webpack_require__(17));
	...
	myApp.config(['NgAdminConfigurationProvider', function (nga) {
	    ...
	    admin.addEntity(nga.entity('productsOptionsets').url(function (entityName, viewType, identifierValue, identifierName) {
	        var url = 'products-optionsets';
	        return identifierValue != undefined ? url + '/' + identifierValue : url;
	    }));
	
	    admin.addEntity(nga.entity('productsOptions').url(function (entityName, viewType, identifierValue, identifierName) {
	        var url = 'products-options';
	        return identifierValue != undefined ? url + '/' + identifierValue : url;
	    }));
	
	    admin.addEntity(nga.entity('productsAttributes').url(function (entityName, viewType, identifierValue, identifierName) {
	        var url = 'products-attributes';
	        return identifierValue != undefined ? url + '/' + identifierValue : url;
	    }));
...
/***/ function(module, exports) {
	...
	(function () {
	    ...
	    angular.module('util', ['util.controllers', 'util.directives', 'util.services']);
	
	    angular.module('util.controllers', []);
...
/***/ function(module, exports) {
	...
	(function () {
	    ...
	    angular.module('util.services').factory('ItemImages', ItemImages);
...
/***/ function(module, exports) {
	...
	(function () {
	    ...
	    angular.module('util.controllers').controller('UploadMultipleImagesController', UploadMultipleImagesController);
	    ...
	    function UploadMultipleImagesController($scope, fileReader, ItemImages, notification, ngDialog) {
	        ...
	        function imageDelete(image) {
	            ...
	            if (vm.images.length > 1) {
	                ...
	                message = 'Al eliminar todas las imagenes de un producto, este quedara inactivo \n ¿Estas seguro?';
	            }
	        ...
	        function changeDefaultImage(image) {
	            ...
	            ngDialog.openConfirm({
	                className: 'ngdialog-theme-plain',
	                template: '<div class="dialog-contents">\
	                                <p><i class="fa fa-question-circle"> </i>A seleccionar una imagen como destacada, sera la imagen que tu producto mostrara por defecto.</p>\
	                                <div class="ngdialog-buttons">\
	                                    <button type="button" class="ngdialog-button ngdialog-button-secondary" ng-click="closeThisDialog(0)">CANCEL</button>\
	                                    <button type="button" class="ngdialog-button ngdialog-button-primary" ng-click="confirm(1)">OK</button>\
	                                </div> </div>',
...
/***/ function(module, exports) {
	...
	(function (module) {
	    ...
	    var fileReader = function fileReader($q) {
...
/***/ function(module, exports) {
	...
	(function () {
	    ...
	    angular.module('util.directives').directive('uploadImages', uploadImages);
...
/***/ function(module, exports) {
	    ...
	    return {
	        ...
	        link: function link(scope, element, attrs) {
	            ...
	            scope.$watch(function () {
	                return scope.$parent.entry.values.product;
	            }, function () {
	                if (scope.$parent.entry.values.product) {
	                    $http.get(window.endpoint + 'products-attributes?products__id=' + scope.$parent.entry.values.product).then(function (response) {
	...
	exports['default'] = dynamicAttributeDirective;
	module.exports = exports['default'];
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _adminConfigLibFieldNumberField = __webpack_require__(10);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Field2 = __webpack_require__(11);
...
/***/ function(module, exports) {
	...
	exports['default'] = {
	   getReadWidget: function getReadWidget() {
	      return '{{ field.currency() }}<ma-number-column field="::field" value="::entry.values[field.name()]"></ma-number-column>';
	   },
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _adminConfigLibFieldTextField = __webpack_require__(15);
	
	var _adminConfigLibFieldTextField2 = _interopRequireDefault(_adminConfigLibFieldTextField);
	
	var AttributeField = (function (_TextField) {
	    _inherits(AttributeField, _TextField);
	
	    function AttributeField(name) {
	        _classCallCheck(this, AttributeField);
	
	        _get(Object.getPrototypeOf(AttributeField.prototype), 'constructor', this).call(this, name);
	    }
	
	    return AttributeField;
	})(_adminConfigLibFieldTextField2['default']);
	
	exports['default'] = AttributeField;
	module.exports = exports['default'];
...
/***/ function(module, exports) {
	...
	exports['default'] = {
	  //getWriteWidget: () => '<span> ESTO! </span>',
	  getReadWidget: function getReadWidget() {
	    return '<attribute-field field="::field" value="::entry.values[field.name()]"></attribute-field>';
	  },
	  getWriteWidget: function getWriteWidget() {
	    return '<attribute-field field="::field" value="::entry.values[field.name()]"></attribute-field>';
	  },
	  getLinkWidget: function getLinkWidget() {
	    return '<a ng-click="gotoDetail()">{{ entry.values.attribute_display }}</a>';
	  }
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _dashboardSummaryHtml = __webpack_require__(18);
	...
	function dashboardSummary(Restangular) {
	    ...
	    return {
	        ...
	        controller: function controller($scope) {
	            ...
	            Restangular.all('item-resources').getList({ stock_lte: 10 }).then(function (resources) {
	                $scope.stats.resources_low_stock = resources.data.reduce(function (nb) {
	                    return ++nb;
	                }, 0);
	            });
	            Restangular.all('orders').getList({ status: 1 }).then(function (orders) {
...
/***/ function(module, exports) {
	...
	exports['default'] = function (nga, admin) {
	    ...
	    addresses.listView().title('Direcciones').fields([nga.field('id'), nga.field('street').label('Direccion')]).filters([nga.field('q', 'template').label('').pinned(true).template('<div class="input-group"><input type="text" ng-model="value" placeholder="Search" class="form-control"></input><span class="input-group-addon"><i class="glyphicon glyphicon-search"></i></span></div>')]).listActions(['edit', 'delete']);
	
	    addresses.creationView().title('Crear direccion').fields([nga.field('street').label('Direccion').validation({ required: true })]);
	
	    addresses.editionView().title('Editar direccion').fields(addresses.creationView().fields());
	    return addresses;
	};
...
/***/ function(module, exports) {
	...
	exports['default'] = function (nga, admin) {
	    ...
	    orderItems.listView().fields([nga.field('id'), nga.field('product_name').label('Nombre de producto'), nga.field('order', 'reference').label('Orden').targetEntity(admin.getEntity('orders')).targetField(nga.field('id')).singleApiCall(function (ids) {
	        return { 'id': ids };
	    })]).listActions(['edit', 'delete']);
	    orderItems.creationView().fields([nga.field('id').editable(false), nga.field('product_name').editable(false), nga.field('price', 'float').editable(false), nga.field('quantity', 'number'), nga.field('product', 'reference').targetEntity(admin.getEntity('productsVariants')).targetField(nga.field('name')).attributes({ placeholder: 'Select order...' }).remoteComplete(true, {
	        refreshDelay: 300,
	        searchQuery: function searchQuery(search) {
	            return { q: search };
	        }
	    }), nga.field('order', 'reference').targetEntity(admin.getEntity('orders')).targetField(nga.field('id')).attributes({ placeholder: 'Select order...' }).remoteComplete(true, {
	        refreshDelay: 300,
	        searchQuery: function searchQuery(search) {
	            return { q: search };
	        }
...
/***/ function(module, exports) {
	...
	exports["default"] = function (nga, admin) {
	    ...
	    productsOptionsets.listView().title('Product option sets').fields([nga.field('id'), nga.field('name').label('Nombre'), nga.field('widget_type', 'choice').choices(widget_types_choices).label('Tipo'), nga.field('category', 'reference').label('Categoria').targetEntity(admin.getEntity('categories')).targetField(nga.field('name')).singleApiCall(function (ids) {
	        return { 'id': ids };
...
/***/ function(module, exports) {
	...
	exports['default'] = function (nga, admin) {
	    ...
	    productsOptions.editionView().title('Editar {{ entry.values.name }}').fields(productsOptions.creationView().fields());
...
/***/ function(module, exports) {
	...
	exports['default'] = function (nga, admin) {
	    ...
	    IOProductsStock.creationView().title('Ingresar stock').fields([nga.field('quantity', 'number').label('Cantidad'), nga.field('date', 'datetime').defaultValue(new Date(Date.now())).label('Fecha'), nga.field('stock', 'reference').label('Producto').targetEntity(admin.getEntity('productsStock')).targetField(nga.field('product_name')).attributes({ placeholder: 'Selecionar producto...' }).remoteComplete(true, {
	    ...
	    }), nga.field('note', 'text').label('Nota')]).onSubmitSuccess(['progression', 'notification', '$state', 'entry', 'entity', function (progression, notification, $state, entry, entity) {
	        // stop the progress bar
	        progression.done();
	        // add a notification
	        notification.log('Se agrego #' + entry._identifierValue + ' exitosamente.', { addnCls: 'humane-flatty-success' });
	        // redirect to the list view
	        //$state.go($state.get('list'), { entity: entity.name() });
	        console.log("ENTITY STOCK");
	        console.log(entity);
	        $state.go($state.get('show'), { entity: 'productsStock', 'id': entry.values.stock });
	        // cancel the default action (redirect to the edition view)
	        return false;
	    }]);
...
/***/ function(module, exports) {
	...
	exports['default'] = function (nga, admin) {
	    ...
	    categories.listView().title('Categorias').fields([nga.field('id'), nga.field('name').label('Nombre')]).filters([nga.field('search', 'template').label('').pinned(true).template('<div class="input-group"><input type="text" ng-model="value" placeholder="Buscar" class="form-control"></input><span class="input-group-addon"><i class="fa fa-search"></i></span></div>')]).listActions(['<ma-filtered-list-button entity-name="products" filter="{ category: entry.values.id }" size="xs" label="Productos relacionados"></ma-filtered-list-button>', 'edit', 'delete']);
	
	    categories.creationView().title('Crear Categoria').fields([nga.field('name').label('Nombre')]);
	
	    categories.editionView().title('Editando categoria {{ entry.values.name }}').fields([nga.field('name').label('Nombre')]);
...
/***/ function(module, exports) {
	...
	exports['default'] = function (nga, admin) {
	    ...
	    tickets.listView().title('Tickets').fields([nga.field('id'), nga.field('type').label('Tipo'), nga.field('actor_type'), nga.field('actor_id'), nga.field('status'), nga.field('amount')]);
	
	    tickets.creationView().title('Create new Address').fields([nga.field('type'), nga.field('actor_type'), nga.field('actor_id'), nga.field('status'), nga.field('amount')]);
	
	    tickets.editionView().fields(tickets.creationView().fields());
	    return tickets;
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports['default'] = function (nga, admin) {
	    ...
	    return nga.dashboard().addCollection(nga.collection(admin.getEntity('itemResources')).name('resources_low_stock').title('Recursos con bajo stock').fields([nga.field('id'), nga.field('name')]).sortField('name').permanentFilters({ stock_lte: 10 }).sortDir('DESC')).addCollection(nga.collection(admin.getEntity('productsVariants')).name('products_low_stock').title('Productos con bajo stock').fields([nga.field('id'), nga.field('sku'), nga.field('name')]).sortField('name').permanentFilters({ stock_lte: 10 }).sortDir('DESC')).addCollection(nga.collection(admin.getEntity('orders')).name('pending_orders').title('Ordenes pendientes').fields([nga.field('id'), nga.field('status'), nga.field('client', 'reference').targetEntity(admin.getEntity('clients')).targetField(nga.field('first_name')).singleApiCall(function (ids) {
	        return { 'id': ids };
	    })]).sortField('created_at').permanentFilters({ status: 1 }).sortDir('DESC')).template('\n            <div class="row dashboard-starter"></div>\n            <dashboard-summary></dashboard-summary>\n        <div class="row dashboard-content">\n        <div class="col-lg-6">\n            <div class="panel panel-primary">\n                <ma-dashboard-panel collection="dashboardController.collections.products_low_stock" entries="dashboardController.entries.products_low_stock" datastore="dashboardController.datastore"></ma-dashboard-panel>\n            </div>\n            <div class="panel panel-yellow">\n                <ma-dashboard-panel collection="dashboardController.collections.resources_low_stock" entries="dashboardController.entries.resources_low_stock" datastore="dashboardController.datastore"></ma-dashboard-panel>\n            </div>\n        </div>\n        <div class="col-lg-6">\n            <div class="panel panel-green">\n                <ma-dashboard-panel collection="dashboardController.collections.pending_orders" entries="dashboardController.entries.pending_orders" datastore="dashboardController.datastore"></ma-dashboard-panel>\n            </div>\n        </div>\n        </div>\n        ');
	};
...
/***/ function(module, exports) {
	...
	exports['default'] = function (nga, admin) {
	    return nga.menu().addChild(nga.menu().title('Configurar Productos').icon('<span class="fa fa-cogs fa-fw"></span>').active(function (path) {
	        return path.indexOf('/productsAttributes') === 0 || path.indexOf('/productsOptionsets') === 0 || path.indexOf('/categories') === 0;
	    }).addChild(nga.menu(admin.getEntity('categories')).title('Categorias').icon('<span class="fa fa-bars fa-fw"></span>'))
	
	    //            .addChild(nga.menu(admin.getEntity('productsOptionsets'))
	    //                .title('Opciones')
	    //                .icon('<span class="fa fa-list-alt fa-fw"></span>'))
	
	    .addChild(nga.menu(admin.getEntity('productsAttributes')).title('Atributos de productos').icon('<span class="fa fa-list-ul fa-fw"></span>'))).addChild(nga.menu().title('Productos').icon('<span class="fa fa-product-hunt fa-fw"></span>').active(function (path) {
	        return path.indexOf('/products/') === 0 || path.indexOf('/productsStock') === 0 || path.indexOf('/productsVariants') === 0;
	    })
	    ...
	    .addChild(nga.menu(admin.getEntity('products')).title('Productos').icon('<span class="fa fa-product-hunt fa-fw"></span>')).addChild(nga.menu(admin.getEntity('productsVariants')).title('Variaciones de productos').icon('<span class="fa fa-product-hunt fa-fw"></span>')).addChild(nga.menu(admin.getEntity('productsStock')).title('Stock').icon('<span class="fa fa-th-list fa-fw"></span>'))
	    ...
	    .addChild(nga.menu().title('Personas').icon('<span class="fa fa-users fa-fw"></span>').active(function (path) {
	        return path.indexOf('/clients') === 0;
	    }).addChild(nga.menu(admin.getEntity('clients')).title('Clientes').icon('<span class="fa fa-user-secret fa-fw"></span>'))
	    ...
	    .addChild(nga.menu().title('Ordenes').icon('<span class="fa fa-shopping-cart fa-fw"></span>').active(function (path) {
	        return path.indexOf('/orders') === 0 || path.indexOf('/payments') === 0;
	    }).addChild(nga.menu(admin.getEntity('orders')).title('Ordenes').icon('<span class="fa fa-shopping-basket fa-fw"></span>'))
	    //.addChild(nga.menu(admin.getEntity('orderItems'))
	    //    .icon('<span class="fa fa-shopping-cart fa-fw""></span>'))
	
	    .addChild(nga.menu(admin.getEntity('payments')).title('Pagos').icon('<span class="fa fa-money fa-fw"></span>'))
